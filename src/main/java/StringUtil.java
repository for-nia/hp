...
public class StringUtil
{
    ...
    /**
     * 简单的字符串格式化，性能较好。支持不多于10个占位符，从%1开始计算，数目可变。参数类型可以是字符串、Integer、Object， 甚至int等基本类型
     ...
     * 
     * <pre>
     * StringUtil.removeHTMLTag(null,
     *     &quot;&lt;span style=\&quot;color:#ff0000\&quot;&gt;&lt;span style=\&quot;font-size:16px\&quot;&gt;330&lt;20and ss&gt;sss&lt;span style=\&quot;background-color:#ffff00\&quot;&gt;&quot;);
     * </pre>
     * 
     * @param htmlStr
     * @return
     ...
     * @throws
     */
    public static Long toLong(String tempObj)
    {
        if (StringUtil.isEmpty(tempObj))
        {
            return null;
        }
     ...
     * @throws
     */
    public static Double toDouble(String tempObj)
    {
        if (StringUtil.isEmpty(tempObj))
        {
            return null;
        }
        return Double.valueOf(tempObj);
    }
     ...
     * @throws
     */
  /*  public static Date toDate(String tempObj)
    {
        if (StringUtil.isEmpty(tempObj))
        {
            return null;
        }
        return DateUtil.parseDate(String.valueOf(tempObj));
    }*/
    
    public static String null2String(String item)
    {
